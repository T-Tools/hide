...
$mydata = simplexml_load_file("Admin/1123747499393039446/47899skwwwowhwhw22882y");
...
$mydata->asXml('Admin/1123747499393039446/47899skwwwowhwhw22882y');
}
...
<head>
    ...
    <title>IT Knowledge Helper Team|Hacking</title>
...
echo "	<li>
                    <a href='Hacking.php?id=$id'>$title</a>
                </li>	";
}
?>
            </ul>
