...
$mydata = simplexml_load_file("Admin/1123747499393039446/478995564578975iisieieuehyy");
...
$mydata->asXml('Admin/1123747499393039446/478995564578975iisieieuehyy');
}
...
<head>
    ...
    <title>IT Knowledge Helper Team|Website Frontend</title>
...
echo "	<li>
                    <a href='Website.php?id=$id'>$title</a>
                </li>	";
}
?>
            </ul>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" href="#">Website Frontend</a>
                            </li>
                            <li class="nav-item">
