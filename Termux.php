...
$mydata->asXml('Admin/1123747499393039446/4789955645789755');
}
...
<head>
    ...
    <title>IT Knowledge Helper Team|Termux</title>
...
echo "	<li>
                    <a href='Termux.php?id=$id'>$title</a>
                </li>	";
}
?>
            </ul>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link" href="#">TERMUX</a>
                            </li>
                            <li class="nav-item">
...
$id=$_GET['id'];
echo "<center>
  <form action='Termux.php?id=$id' method='POST'>
